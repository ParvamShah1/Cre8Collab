    ...
    <section id="statistics" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-8"> */}
          {/* Growth Chart */}
          {/* <div className="bg-white p-6 rounded-xl shadow-lg animate__animated animate__fadeInLeft">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Platform Growth</h3>
            <div className="h-64 bg-gray-50 rounded-lg"></div>
          </div> */}

          {/* Engagement Metrics */}
          {/* <div className="bg-white p-6 rounded-xl shadow-lg animate__animated animate__fadeInRight">
